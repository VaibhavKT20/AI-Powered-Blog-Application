      ...
      <td className="px-2 sm:px-3 py-2">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
          <button
            ...
            className={`px-2 sm:px-4 py-1 rounded-xl text-xs sm:text-sm font-semibold shadow-sm transition-all w-full sm:w-auto text-center cursor-pointer ${
              isPublished
          ...
          <button
            onClick={deleteBlog}
            className="w-full sm:w-auto flex justify-center items-center bg-red-100 text-red-700 rounded-xl px-2 py-1 sm:px-3 sm:py-1 text-xs sm:text-sm hover:bg-red-200 transition-all cursor-pointer"
          >
            <img
